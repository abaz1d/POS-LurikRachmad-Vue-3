                  ...
                  <form @submit.prevent="addSatuan" id="addSatuanForm" class="col-span-12">
                      <div class="col-span-12 mb-5">
                          ...
                          <input id="pos-form-1" type="text" class="form-control flex-1"
                              placeholder="Masukan Nama Barang" v-model="inputNamaSatuan" required />
                      </div>
                      <div class="col-span-12">
                          <label for="pos-form-5" class="form-label">Keterangan Barang</label>
                          <textarea id="pos-form-5" class="form-control" placeholder="Masukan Keterangan Barang"
                              v-model="inputKeteranganSatuan" required />
                          <small class="text-grey-800 text-xs">Contoh : Digunakan untuk mewakili barang stok
                              ketersediaan
...
export default {
  ...
  methods: {
      addSatuan() {
          try {
              ...
              this.Barang.addItem(inputNamaSatuan.value, inputKeteranganSatuan.value)
  ...
  mounted() {
      ...
      // this.satuans = this.Barang.items
  }
}
</script>
