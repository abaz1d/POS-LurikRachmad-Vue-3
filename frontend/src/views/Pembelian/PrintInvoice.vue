<template>
  <div class="intro-y bg-white box overflow-hidden mt-2">
    <div class="flex bg-white flex-col lg:flex-row pt-10 px-5 sm:px-20 sm:pt-20 lg:pb-20 text-center sm:text-left">
      ...
      <div class="mt-20 bg-white lg:mt-0 lg:ml-auto lg:text-right">
        <div class="text-xl text-primary font-medium">Left4code</div>
        <div class="mt-1 text-black">left4code@gmail.com</div>
        <div class="mt-1 text-black">8023 Amerige Street Harriman, NY 10926.</div>
      </div>
    </div>
