    ...
    <div class="container sm:px-10 overflow-auto">
      <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
          <div class="intro-y flex items-center mt-8 text-white cursor-pointer hover:text-[#CDA562]"
            @click="$router.go(-1)">
            <ArrowLeftIcon class="w-10 inline-block" />
            <h2 class="text-lg font-medium mr-auto">Kembali</h2>
          </div>
          <div class="my-auto">
            <img alt="Lurik Rachmad HTML" width="100" height="100"
              class="-intro-x w-1/2 -mt-16 fill-[#CDA562] hidden dark:block" src="@/assets/images/logo-gold.svg" />
            <img alt="Lurik Rachmad HTML" width="100" height="100"
              class="-intro-x w-1/2 -mt-16 fill-white block dark:hidden" src="@/assets/images/logo.svg" />
            <div
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
          <div
            ...
            <div class="intro-x mt-8">
              <div class="box shadow-black shadow-2xl p-2 rounded-lg">
