    ...
    <AccordionTable
      ...
      <div class="col" v-if="isEdit">
        <div class="flex justify-center items-center">
          <button class="flex items-center mr-3 text-primary" type="button" @click="updateBarang(barang.id_barang)">
...
isVarian = false;
      ...
      <ChevronDownIcon class="animate-bounce col-span-3 mt-[-15px] mb-[-20px] block mx-auto" />
      <!-- </tr> -->
    </AccordionTable>

    <AccordionPanelTable
      class="col-span-3 text-slate-600 dark:text-slate-500 leading-relaxed border-r-4 border-b-4 border-l-4 border-b-0 border-blue-200 dark:border-blue-800 rounded-b-lg pb-2 mb-2">
