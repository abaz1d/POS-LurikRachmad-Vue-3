          ...
          <div class="bg-white px-4 py-5 sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-3 mb-0">
                ...
                <label for="idVarian" class="block text-sm font-medium text-gray-700">ID Varian</label>
                <input id="idVarian" type="text"
                  ...
                  placeholder="Masukan Nama Varian" v-model="id_varian" readonly />
              ...
              <div class="col-span-6 sm:col-span-3">
                <label for="namaVarian" class="block text-sm font-medium text-gray-700">Nama Varian</label>
                <input id="namaVarian" type="text"
                  class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  placeholder="Masukan Nama Varian" v-model="nama_varian" />
              </div>

              <div class="col-span-6 sm:col-span-3">
                <label for="pos-form-1" class="block text-sm font-medium text-gray-700">Kategori Barang</label>
                <select v-model="kategori_barang" id="pos-form-1"
                  ...
                  <option v-for="barang in data.barang" :key="barang.id_barang" :barang="barang"
                    :value="barang.id_barang" :selected="kategori_barang == barang.id_barang">
              ...
              <div class="col-span-6 sm:col-span-3">
                <label for="pos-form-1" class="block text-sm font-medium text-gray-700">Kategori Gudang</label>
                <select v-model="gudang" id="pos-form-1"
                  class="form-select mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                  aria-label="Default select example">
                  <option v-for="gudang in data.gudang" :key="gudang.id_gudang" :gudang="gudang"
                    :value="gudang.id_gudang" :selected="gudang == gudang.id_gudang">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input id="stokVarian" type="number"
                  class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  placeholder="Masukan Stok Varian" v-model="stok_varian" />
              </div>

              <div class="col-span-6 sm:col-span-3">
                <label for="satuanVarian" class="block text-sm font-medium text-gray-700">Satuan Varian</label>
                <select v-model="satuan_varian" id="satuanVarian"
                  class="form-select mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                  aria-label="Default select example">
                  <option v-for="satuan in data.satuan" :key="satuan.id_satuan" :satuan="satuan"
                    :value="satuan.id_satuan" :selected="satuan_varian == satuan.id_satuan">
              ...
              <div class="col-span-6 sm:col-span-3">
                <label for="hargaBeliVarian" class="block text-sm font-medium text-gray-700">Harga Beli Varian</label>
                <input id="hargaBeliVarian" type="number"
                  class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  placeholder="Masukan Harga Beli Varian" v-model="harga_beli" />
              </div>

              <div class="col-span-6 sm:col-span-3">
                <label for="hargaJualVarian" class="block text-sm font-medium text-gray-700">Harga Jual Varian</label>
                <input id="hargaJualVarian" type="number"
                  class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              ...
              <div class="col-span-6 sm:col-span-6">
                ...
                <div class="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                  <div class="space-y-1 text-center">
                    <svg v-if="gambar_varian == null || ''" class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor"
                    ...
                    <div v-else class="col-span-5 md:col-span-2 relative image-fit cursor-pointer zoom-in"
                      style="height: 9rem;">
                      <img v-if="urlPreview === null" class="rounded-md" alt="Midone - HTML Admin Template"
                        :src="gambar_lama_preview" />
                      <img v-else class="rounded-md" alt="Midone - HTML Admin Template" :src="urlPreview" />
                      <Tippy content="Remove this image?" @click="urlPreview = null"
...
export default {
  ...
  methods: {
    ...
    updateVarian(e) {
      try {
        console.log('idvr', this.id_varian.valueOf())
