  ...
  <div class="grid grid-cols-12 gap-6 mt-5">
    ...
    >
      <button
        ...
        @click="addModal = true"
      >
      <PlusIcon class="w-4 h-4 mr-2" /> <p class="hidden xl:block mr-1">Supplier</p> Baru
      </button>
