  ...
  <Modal backdrop="static" size="modal-xl" :show="isInvoice" @hidden="isInvoice = false">
    <ModalHeader>
      <h2 class="font-medium text-base mr-auto">
        <button class="btn btn-primary shadow-md mr-2" @click="onPrintInvoice" v-if="!isEdit">
          <PrinterIcon class="w-4 h-4 mr-2" /> Print
        </button>
    ...
    <ModalBody class="">
      <div class="bg-white" :prints="BarangMasuk.prints" :mutasi="data_utama" :isEdit="isEdit">
        ...
        <div class="intro-y bg-white box overflow-hidden mt-2 z-50 absolute top-0" style="background-color: white;"
          ...
          <div class="min-w-max bg-white">
            <div class="grid sm:grid-cols-3 bg-white">
              ...
              <div class="col-span-2 hidden sm:block mr-40">
                <div class="grid justify-items-center items-center bg-white">
                  <div class="font-philosopher bg-white text-4xl text-[#CDA562] font-black bg-white"> <b> Lurik Rachmad
                    </b>
                  </div>
                  <div class="bg-white mt-1 text-black">Jalan Pedan – Cawas Rt 002 Rw 001 Desa/Kelurahan Beji, <br>
                    Kecamatan
            ...
            <hr class="mx-8 border-2 my-2 text-black fill-black stroke-black border-black">
            <p class="text-center text-lg font-bold underline text-black">SURAT JALAN</p>
          </div>
          <div
      ...
      <div class="bg-white mt-1 text-left text-black text-base font-medium">Waktu : {{ moment(mutasi.tanggal_mutasi).format("DD MMM YYYY HH:SS") }}</div> -->
            ...
            <div class="bg-white mt-10 lg:mt-0 lg:ml-auto lg:text-right">
              <div class="bg-white mt-1 text-black text-left text-base font-medium">Penerima : {{
          ...
          <div class="px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row bg-white">
            <div class="text-center sm:text-left mt-10 sm:mt-0 bg-white">
              <div class="text-center">
                <div class="text-base text-slate-500">Tanda Terima,</div>
                <div class="">{{ data_utama.id_outlet_penerima }} - {{ data_utama.penerima }}</div>
            ...
            <div class="text-center sm:text-right sm:ml-auto bg-white">
              <div class="text-center">
                ...
                <div class="">{{ data_utama.id_outlet_pengirim }} - {{ data_utama.pengirim }}</div>
